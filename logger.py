...
__all__ = ["logger", "set_model_degradation_threshold", "set_model_performance_baseline",
=======
# logger.py
# Настройка логирования с использованием loguru и JSON.
"""Модуль для настройки логирования и отслеживания деградации модели."""
...
# Экспорт logger для использования в других модулях
__all__ = ["logger", "set_model_degradation_threshold", "set_model_performance_baseline",
>>>>>>> 76a4df78f793be0478ce58e3b5d51269b4ae0244
           "add_model_metrics", "get_model_metrics_history", "check_model_degradation"]