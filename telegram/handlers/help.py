...
async def cmd_help(message: Message):
    ...
    try:
        ...
        await message.answer(f"❌ Произошла ошибка при отправке {command}. Попробуйте позже.", parse_mode="HTML")
...
async def cb_show_help(callback: CallbackQuery):
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Невозможно отредактировать сообщение для /help (callback) у {callback.from_user.id}: {e}. Отправляем новое.")
...
async def cb_show_examples(callback: CallbackQuery):
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Невозможно отредактировать сообщение для /examples (callback) у {callback.from_user.id}: {e}. Отправляем новое.")
...
async def cb_show_stats(callback: CallbackQuery):
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Невозможно отредактировать сообщение для /stats (callback) у {callback.from_user.id}: {e}. Отправляем новое.")
